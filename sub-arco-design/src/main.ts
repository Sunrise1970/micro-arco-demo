...
/** ********************监听事件***********************/
window.addEventListener(`unmount-appName1`, destroyWindowListen, true)

function destroyWindowListen() {
  window.eventCenterForChildApp_1?.clearDataListener()
  // console.log(34, '监听卸载事件')
  window.removeEventListener('unmount-appName1', destroyWindowListen, true)
}
// 判断是否为微前端环境
/*if(window.__MICRO_APP_BASE_APPLICATION__){
  console.log(34, window.__MICRO_APP_NAME__)
  window[`micro-app-appName1`]= { unmount }
